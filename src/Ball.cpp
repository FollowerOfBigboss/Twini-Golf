...
void Ball::update(double deltaTime, bool mouseDown, bool mousePressed, const std::vector<Tile>& tiles, const std::vector<Hole>& holes, Mix_Chunk* chargeSfx, Mix_Chunk* swingSfx, Mix_Chunk* holeSfx)
{
    if (win)
    {
